          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full border rounded-lg px-3 py-2.5 pr-10 text-[14px] focus:outline-none transition-colors
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-text hover:text-ink transition-colors"
                tabIndex={-1}
              >
                {showPassword ? (
